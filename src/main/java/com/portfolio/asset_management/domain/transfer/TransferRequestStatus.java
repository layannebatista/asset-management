 ...
 *
 * Este enum representa exclusivamente o lifecycle da TransferRequest.
 * Não deve ser reutilizado por projeções, DTOs ou outros modelos.
 *
 * Status do processo ≠ Status do ativo.
 */
public enum TransferRequestStatus {
  ...
  /**
   * Solicitação em fluxo de aprovação.
   * O ativo deve estar bloqueado para outras ações.
   */
  EM_APROVACAO(false),

  /**
   * Solicitação aprovada formalmente.
   * Aguardando execução da transferência.
   */
  APROVADA(false),
  ...
  /**
   * Solicitação cancelada antes da execução.
   * Estado final.
   */
  CANCELADA(true);
