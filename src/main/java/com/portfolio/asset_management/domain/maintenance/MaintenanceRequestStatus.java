 ...
 *
 * <p>Este enum representa exclusivamente o lifecycle da MaintenanceRequest.
 *
...
public enum MaintenanceRequestStatus {
  ...
  /** Manutenção em andamento. O ativo deve estar fora de uso. */
  EM_MANUTENCAO(false),

  /** Manutenção finalizada com sucesso. Estado final. */
  FINALIZADA(true),

  /** Solicitação cancelada. Estado final. */
  CANCELADA(true);
