 ...
 *
 * Este enum faz parte da linguagem ubíqua do domínio.
 * Cada ação representa uma intenção explícita do negócio,
 * e NÃO uma simples mudança de status.
 *
 * As permissões de execução são controladas pelo AssetStatus.
 * As regras de execução ficam no domínio (Asset).
 */
