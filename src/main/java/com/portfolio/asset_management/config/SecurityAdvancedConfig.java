...
public class SecurityAdvancedConfig {
  ...
  public AbacPolicyConfig abacPolicyConfig() {
    return new AbacPolicyConfig(Set.of("BRANCH", "ROLE", "ASSET_STATUS"), true);
  }
  ...
  public static class TokenPolicy {
    ...
    public TokenPolicy(Duration accessTokenTtl, Duration refreshTokenTtl, Duration magicLinkTtl) {
