...
public class TransferController {
  ...
  public TransferRequest criarTransferRequest(
    ...
    return transferService.criarTransferRequest(assetId, destinationUnitId, requestedBy);
  }
  ...
  public TransferApproval aprovarTransferencia(
    ...
    return transferService.aprovarTransferencia(requestId, approvedBy, comment);
  }
  ...
  public TransferApproval rejeitarTransferencia(
      @PathVariable UUID requestId, @RequestParam UUID rejectedBy, @RequestParam String reason) {

    return transferService.rejeitarTransferencia(requestId, rejectedBy, reason);
  }
  ...
  public void executarTransferencia(
      @PathVariable UUID requestId, @RequestParam UUID newResponsibleUserId) {

    transferService.executarTransferencia(requestId, newResponsibleUserId);
  }
  ...
  public void cancelarTransferencia(
      @PathVariable UUID requestId, @RequestParam UUID cancelledBy, @RequestParam String reason) {

    transferService.cancelarTransferencia(requestId, cancelledBy, reason);
  }
