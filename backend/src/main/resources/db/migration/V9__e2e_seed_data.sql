-- ============================================================
-- V9: Dados de seed para testes E2E
-- Garante que os filtros por "Disponível" e "Atribuído" sempre
-- encontrem resultados, mesmo após outros testes consumirem ativos.
-- ============================================================

-- 10 ativos AVAILABLE distribuídos entre as unidades
...
-- 5 ativos ASSIGNED (atribuídos ao admin)
INSERT INTO public.assets (asset_tag, type, model, status, organization_id, unit_id, user_id, version)
