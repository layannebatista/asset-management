...
public class TransferController {
  ...
  public PageResponse<TransferResponseDTO> list(
      @Parameter(description = "Status da transferência") @RequestParam(required = false) TransferStatus status,
      @Parameter(description = "ID do ativo") @RequestParam(required = false) Long assetId,
      @Parameter(description = "ID da unidade (origem ou destino)") @RequestParam(required = false) Long unitId,
    ...
    Page<TransferRequest> page = queryService.list(status, assetId, unitId, startDate, endDate, pageable);
  ...
  public ResponseEntity<TransferResponseDTO> request(@RequestBody @Valid TransferCreateDTO dto) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(transferMapper.toResponseDTO(
  ...
  public ResponseEntity<Void> approve(
      ...
      @RequestBody(required = false) TransferApproveDTO dto) {
