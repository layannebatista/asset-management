...
public class AssetIdleItemDTO {
  ...
  public AssetIdleItemDTO(String assetTag, String model, String type, long idleDays) {
    this.assetTag = assetTag; this.model = model; this.type = type; this.idleDays = idleDays;
  }
  ...
  public long getIdleDays() { return idleDays; }
  public void setIdleDays(long v) { this.idleDays = v; }
}
