...
public class DashboardData {
  ...
  public void setAssetsByStatus(List<Object[]> v) {
    this.assetsByStatus = v;
  }
  ...
  public void setAssetsByUnit(List<Object[]> v) {
    this.assetsByUnit = v;
  }
  ...
  public void setAssetsByType(List<Object[]> v) {
    this.assetsByType = v;
  }
  ...
  public void setTotalMaintenance(Long v) {
    this.totalMaintenance = v;
  }
  ...
  public void setMaintenanceByStatus(List<Object[]> v) {
    this.maintenanceByStatus = v;
  }
  ...
  public void setMaintenanceByMonth(List<Object[]> v) {
    this.maintenanceByMonth = v;
  }
  ...
  public void setTransferByStatus(List<Object[]> v) {
    this.transferByStatus = v;
  }
  ...
  public void setTransferByMonth(List<Object[]> v) {
    this.transferByMonth = v;
  }
  ...
  public void setUsersByStatus(List<Object[]> v) {
    this.usersByStatus = v;
  }
  ...
  public void setUsersByRole(List<Object[]> v) {
    this.usersByRole = v;
  }
  ...
  public void setAssetsAvailable(Long v) {
    this.assetsAvailable = v;
  }

  public Long getAssetsRetiredThisMonth() {
    return assetsRetiredThisMonth;
  }

  public void setAssetsRetiredThisMonth(Long v) {
    this.assetsRetiredThisMonth = v;
  }

  public Long getAssetsIdleCount() {
    return assetsIdleCount;
  }

  public void setAssetsIdleCount(Long v) {
    this.assetsIdleCount = v;
  }
  ...
  public void setPendingTransfersCount(Long v) {
    this.pendingTransfersCount = v;
  }

  public BigDecimal getMaintenanceCostMonth() {
    return maintenanceCostMonth;
  }

  public void setMaintenanceCostMonth(BigDecimal v) {
    this.maintenanceCostMonth = v;
  }

  public Long getInsuranceExpiringCount() {
    return insuranceExpiringCount;
  }

  public void setInsuranceExpiringCount(Long v) {
    this.insuranceExpiringCount = v;
  }
  ...
  public void setUtilizationRate(Double v) {
    this.utilizationRate = v;
  }

  public List<AssetIdleItemDTO> getAssetsIdleList() {
    return assetsIdleList;
  }

  public void setAssetsIdleList(List<AssetIdleItemDTO> v) {
    this.assetsIdleList = v;
  }
