...
public class ExecutiveDashboardDTO {
  ...
  public void setAssetsByStatus(Map<String, Long> v) {
  ...
  public void setAssetsByUnit(Map<String, Long> v) {
    this.assetsByUnit = v;
  }
  ...
  public void setAssetsByType(Map<String, Long> v) {
    this.assetsByType = v;
  }
  ...
  public void setMaintenanceByStatus(Map<String, Long> v) {
  ...
  public void setMaintenanceByMonth(Map<String, Long> v) {
  ...
  public void setTransferByStatus(Map<String, Long> v) {
  ...
  public void setTransferByMonth(Map<String, Long> v) {
  ...
  public void setUsersByStatus(Map<String, Long> v) {
  ...
  public void setUsersByRole(Map<String, Long> v) {
    this.usersByRole = v;
  }
