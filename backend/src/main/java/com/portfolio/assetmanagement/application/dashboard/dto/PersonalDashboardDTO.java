...
public class PersonalDashboardDTO {
  ...
  public Long getTotalAssetsAssigned() { return totalAssetsAssigned; }
  public void setTotalAssetsAssigned(Long v) { this.totalAssetsAssigned = v; }
  public Long getTotalMaintenanceRelated() { return totalMaintenanceRelated; }
  public void setTotalMaintenanceRelated(Long v) { this.totalMaintenanceRelated = v; }
