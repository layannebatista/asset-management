...
Funcionalidade: Seguranca e Acesso do Modulo Dashboard
  ...
  Quero acessar dashboard respeitando autenticacao e autorizacao
  ...
  Cenário: DASHBOARD fluxo principal com ADMIN retorna sucesso
    Quando acesso o endpoint de sucesso do módulo "dashboard" autenticado como "admin@acme.com" com senha "Senha@123"
    Então a resposta deve ter status 200

  @blocker
  @allure.severity.blocker
  Cenário: DASHBOARD sem autenticacao retorna 401
    Quando acesso o endpoint de sucesso do módulo "dashboard" sem autenticação
    Então a resposta deve ter status 401

  @critical
  @allure.severity.critical
  Cenário: DASHBOARD com papel sem permissao retorna 403
    Quando acesso o endpoint restrito do módulo "dashboard" autenticado como "gestor@acme.com" com senha "Senha@123"
    Então a resposta deve ter status 403

  @blocker
  @allure.severity.blocker
  Cenário: DASHBOARD com JWT invalido retorna 401
    Quando acesso o endpoint de sucesso do módulo "dashboard" com token inválido "jwt.invalido.dashboard"
    Então a resposta deve ter status 401
